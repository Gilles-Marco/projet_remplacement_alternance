export default {
    ...
    <form>
        <div>
            ...
            <input v-model="host_server" type="text" name="host-server" placeholder="http://localhost:8080" @input="emitObject"/>
        </div>
        <div>
            <label for="server-resource">Ressource du serveur</label>
            <input type="text" name="server-resource" placeholder="/helloworld" v-model="server_resource" @input="emitObject"/>
        </div>
    </form>
    ...
    <form>
        <div>
            ...
            <select v-model="http_method" name="request-method" @change="emitObject">
